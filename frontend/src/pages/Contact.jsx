  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact Collinalitics to start a data project, request a quote, or ask a question." />
      </Helmet>
      ...
      <section className="container">
        ...
        {ok && (
          <div className="alert" style={{ background:'#10331f', border:'1px solid #2b6b45', color:'#bfffe0', borderRadius:10, padding:12, margin:'12px 0' }}>
